...
public class TrackerServiceContainer implements Container {
  ...
  public TrackerRequestProcessor.RequestHandler getRequestHandler(final HttpServletResponse response) {
    return (code, description, responseData) -> {
  ...
  public TrackerRequestProcessor getMyRequestProcessor() {
    return myRequestProcessor;
  }
}
